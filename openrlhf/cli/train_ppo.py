...
def train(args):
    ...
    print(f"critic_pretrain: {args.critic_pretrain}, normalize_reward: {args.normalize_reward}, flash_attn: {args.flash_attn}, bf16: {args.bf16}, load_in_4bit: {args.load_in_4bit}, lora_rank: {args.lora_rank}, lora_alpha: {args.lora_alpha}, target_modules: {args.target_modules}, lora_dropout: {args.lora_dropout}, target_modules: {args.target_modules}, value_head_prefix: {args.value_head_prefix}, ds_config: {strategy.get_ds_train_config(is_actor=False)}, init_value_head: {strategy.args.pretrain == strategy.args.critic_pretrain}")
