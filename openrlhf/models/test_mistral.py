...
if __name__ == "__main__":
    model_path = "/home/wangxiaorong/workspace/o1/checkpoints/Eurus-RM-7b"
    ds_config = {'steps_per_print': 100, 'zero_optimization': {'stage': 2, 'offload_param': {'device': 'none'}, 'offload_optimizer': {'device': 'cpu', 'pin_memory': True}, 'sub_group_size': 'auto', 'stage3_max_live_parameters': 'auto', 'stage3_max_reuse_distance': 'auto', 'stage3_param_persistence_threshold': 'auto', 'stage3_prefetch_bucket_size': 'auto', 'reduce_bucket_size': 'auto', 'zero_hpz_partition_size': 1, 'zero_quantized_weights': False, 'zero_quantized_gradients': False}, 'bf16': {'enabled': True}, 'gradient_clipping': 1.0, 'prescale_gradients': False, 'wall_clock_breakdown': False, 'data_types': {'grad_accum_dtype': 'fp32'}, 'train_micro_batch_size_per_gpu': 2, 'train_batch_size': 128}
    ...
    inputs = torch.load("/home/wangxiaorong/workspace/o1/OpenRLHF/inputs_llama.pt")
    sequences, action_mask, attention_mask = inputs["sequences"], inputs["action_mask"], inputs["attention_mask"]
    print(sequences, action_mask, attention_mask)
    
    output = model(sequences, action_mask, attention_mask)
    print(output)